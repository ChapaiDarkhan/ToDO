...
$(function () {
  ...
  // Authentication: none
  $authControl.find("[data-user='none']").click(function (event) {
    event.preventDefault()
    window.auth = null
    $selectedAuthentication.text('none')
    $authControl.find("[data-user]").closest('li').removeClass('active')
    $authControl.find("[data-user='none']").closest('li').addClass('active')
  })
  ...
  $('form.authentication-token-form').submit(function (event) {
    ...
    $authControl.find("[data-user]").closest('li').removeClass('active')
    $authControl.find("[data-user='token']").closest('li').addClass('active')
  ...
  $('form.authentication-basic-form').submit(function (event) {
    ...
    $authControl.find("[data-user]").closest('li').removeClass('active')
    $authControl.find("[data-user='basic']").closest('li').addClass('active')
  ...
  $('form.authentication-session-form').submit(function (event) {
    ...
    $authControl.find("[data-user]").closest('li').removeClass('active')
    $authControl.find("[data-user='session']").closest('li').addClass('active')
